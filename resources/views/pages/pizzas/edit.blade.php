...
<div class="row mb-2">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Edit {{ $pizza->name }}</li>
        </ol>
    </div>
</div>
@endsection
                ...
                <form action="{{ route('pizzas.update', $pizza) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 text-start">
                        ...
                        <textarea 
                            ...
                            id="description" 
                            rows="3" 
                            class="form-control @error('description') is-invalid @enderror">{{ old('description', $pizza->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3 text-center">
                        <img src="{{ asset($pizza->url) }}" alt="{{ $pizza->name }}" class="img-thumbnail mb-2" style="max-height: 200px;">
                    ...
                    <div class="d-flex justify-content-center mt-4" style="gap: 10px">
                        <a href="{{ route('pizzas.index') }}" class="btn btn-secondary btn-lg">Cancel</a>
